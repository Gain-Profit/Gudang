...
uses
  ...
  Dialogs, StdCtrls, sButton, sEdit, sLabel, UFungsi, Buttons, sSkinProvider,
  ...
  try
    if supp_baru = true then
      fungsi.SQLExec(dm.Q_Exe,
        'insert into tb_pelanggan (kd_perusahaan,kd_pelanggan,no_rekening,n_pelanggan,alamat, ' +
        'telephone,alamat_kirim,`limit`,`update`)values ("' + dm.kd_perusahaan +
        '","' + ed_kode.Text + '","' + ed_rekening.Text + '","' + ed_nama.Text +
        '","' + ed_alamat.Text + '","' + ed_telp.Text + '","' + ed_alamat_kirim.Text
        + '","' + ed_limit.Text + '","' + formatdatetime('yyyy-MM-dd', date()) +
        '")', false)
    else
      fungsi.SQLExec(dm.Q_Exe, 'update tb_pelanggan set `update`="' +
        formatdatetime('yyyy-MM-dd', date()) + '",alamat="' + ed_alamat.Text +
        '",no_rekening="' + ed_rekening.Text + '",alamat_kirim="' +
        ed_alamat_kirim.Text + '",`limit`="' + ed_limit.Text + '",n_pelanggan="'
        + ed_nama.Text + '",telephone="' + ed_telp.Text +
        '" where kd_pelanggan="' + ed_kode.Text + '" and kd_perusahaan="' + dm.kd_perusahaan
        + '" ', false);
