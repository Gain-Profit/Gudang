...
uses
  ...
  Dialogs, Buttons, sBitBtn, ComCtrls,
  ...
  cxGrid,UFungsi, cxStyles, sSpeedButton,
...
uses u_dm, u_purchase, u_utama, u_RO;
...
begin
fungsi.SQLExecT(dm.q_list_purchase,'select * from vw_list_purchase  where kd_perusahaan="'+dm.kd_perusahaan+'" and tgl_purchase >= '+
...
procedure Tf_List_purchase.FormClose(Sender: TObject;
...
procedure Tf_List_purchase.t_dataCellDblClick(
