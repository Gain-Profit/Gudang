...
uses
  ...
  Dialogs, StdCtrls, Buttons, sBitBtn, ComCtrls,
...
begin
fungsi.SQLExecT(dm.q_list_purchase,'select * from vw_list_purchase  where kd_perusahaan="'+f_utama.sb.panels[3].Text+'" and tgl_purchase >= '+
