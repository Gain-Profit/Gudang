...
begin
fungsi.SQLExecT(dm.Q_List_SO,'select * from tb_koreksi_global where kd_perusahaan="'+
f_utama.sb.panels[3].Text+'" and tgl_koreksi >= '+
...
procedure Tf_list_SO.FormClose(Sender: TObject;
...
quotedstr(f_utama.sb.Panels[3].Text)+' and kd_koreksi="'+dm.Q_List_SO.fieldbyname('kd_koreksi').AsString+'"',true);
