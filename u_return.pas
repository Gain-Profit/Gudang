...
uses
  ...
  sDialogs, cxFilter, cxData, sMaskEdit;
...
dm.kd_perusahaan+'" and kd_return="'+ed_no_faktur.Text+'"',true);
...
ed_fak_receipt.Text+'" and kd_perusahaan="'+dm.kd_perusahaan+'" and supplier ="'+ed_supplier.Text+'"',true);
