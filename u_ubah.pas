...
//merubah harga baru setelah diskon
  if ed_harga3.Value <> 0 then
    ed_discP.Value := (ed_discRp.Value / ed_harga3.Value) * 100 else
    ed_discP.Value := 0;
  ...
  if ed_pokok.Value <> 0 then
    ed_marginPNew.Value := (ed_marginrpNew.Value / ed_pokok.Value) * 100 else
...
begin
  ...
  begin
    fungsi.SQLExec(dm.Q_Exe,
      ...
      ed_marginrp.Text + '","' + ed_harga1.Text + '","' + ed_harga2.Text + '","' + ed_harga3.Text
...
begin
  ...
  if ed_pokok.Value <> 0 then
    ed_marginP.Value := (ed_marginrp.Value / ed_pokok.Value) * 100 else
    ed_marginP.Value := 0;
