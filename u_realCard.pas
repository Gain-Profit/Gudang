...
procedure Tf_realCard.ed_PIDKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
...
procedure Tf_realCard.lv_dataKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tf_realCard.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
if Key= vk_f2 then
ed_PID.SetFocus;
